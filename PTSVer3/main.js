...
function place() {
  ...
  // display it reads double and the guard lets the sort run on motes far too small to
  // need it — at this population that is a re-sort and a full attribute rewrite every
  // fourth frame, which stutters and pops the blend order with it.
