# PTSVer19 — corner particle cloud, under a label
...
`?ui=1` shows it. Ten bars in ver19 — the seven hover ones, the two for the sign's pull, and
the leash. The three that are not hover are the new mechanisms, and they are on the panel
