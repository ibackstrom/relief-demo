// immersive-g.com home bas-relief reveal — ver8.
// ver7 with the feather offered in three sizes; see ?feather below.
...
const FEATHER_SIZE = ['s', 'm', 'l'].includes(PARAMS.get('feather')) ? PARAMS.get('feather') : 'm';
...
if (!SITE_MASK) {
  ...
  document.title = 'ver8 — feather: ' + sizeName + ' (?feather=' + FEATHER_SIZE + ')';
  const hint = document.getElementById('hint');
  if (hint) hint.textContent = 'feather: ' + sizeName + '  —  ?feather=s / m / l';
}
