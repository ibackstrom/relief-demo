...
const CHROMATIC = {
  ...
  //
  // Given as a number on the 0..1 wheel, never as a hex picked by eye: 0.993 is a deep
  // red a hair to the magenta side of pure, and a colour chosen visually lands elsewhere.
  hue: 0.993,
  ...
  satRange: [0.533, 0.970],
  valRange: [0.479, 0.910],
...
// again.
//
// ON, because this build exists to find a saturation. ?ui=0 hides it; the settled values
// go into CHROMATIC above and the panel goes back off, as it is in ver18.
