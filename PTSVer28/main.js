...
const CONFIG = {
  ...
  offsetX: 0.391,           // viewport heights, positive toward the corner's own side. ver18's
                            //   0.150 plus 0.241, which is 200 px at a window 830 px tall
  offsetY: 0.411,           // and 0.230 plus 0.181, which is 150 px at the same height. Both
                            //   are FRACTIONS of the viewport, not pixels, so the move holds
                            //   its proportion as the window changes rather than staying 200
                            //   px on a screen twice the size. If the reference height is
                            //   wrong the ratio is off by that much — ?x= and ?y= take them
                            //   live, and they are the two numbers to send back
