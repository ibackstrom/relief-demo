// immersive-g.com home bas-relief reveal — ver10.
// ver9 with the two radii taken apart. ver9 moved them together: shrinking the reveal
// shrank the red with it, because the dye that carries the colour was sized to the
// reveal brush. The customer wants the reveal back at FULL size and only the red half
// as wide, so that a hover shows plain grey relief around a smaller red core.
//   REVEAL_ZONE  the grey patch — the relief that comes out of the wall. Back to 1.
//   COLOR_ZONE   the red inside it, as a fraction of the reveal. 0.5.
...
if (!SITE_MASK) {
  ...
  document.title = 'ver10 — feather: ' + sizeName + ', rim: ' + MASK.fresnelOpacity
                 + ', zone: ' + REVEAL_ZONE + ', red: ' + COLOR_ZONE;
