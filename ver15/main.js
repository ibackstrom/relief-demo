// immersive-g.com home bas-relief reveal — ver15.
// ver14 with the wash's numbers changed and nothing else — no shader, no structure:
...
if (!SITE_MASK) {
  ...
  document.title = 'ver15 — background wash: ' + bgName
