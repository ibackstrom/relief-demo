...
const CONFIG = {
  ...
  seedLobes: 0.42,          // how far the lobes push the radius in and out. 0 is a circle
  seedAspectX: 1.45,        // stretch along the row ...
  seedAspectY: 0.85,        // ... and across it
  ...
  cornerRadius: 0.22,       // AURORA ver11: back to ver10's pair (with cornerBias below) —
  ...
  simSpeed: 0.085,          // AURORA ver11: back to ver10's pace — the customer asked for
  ...
  simFrequency: 1.4,        // eddy size, as 1/frequency in world units. LOW on purpose: this
  ...
  flightDur: 1.80,          // seconds a mote takes to cross, on average (1.26 - 2.34)
  flightSpread: 1.60,       // seconds of random delay across the population, so it leaves as
  ...
  flightArc: 0.28,          // how far a mote's path bows off the straight line, as a fraction
                            //   of the journey. Mostly upward - the menu is near the bottom of
                            //   the frame and a downward bow would leave it
  flightNoise: 0.18,        // ver15: how far a mote WANDERS off its route, as a fraction of
